...
(defn- create-tab-content-wrapper
  ...
  (let [wrapper (JPanel. (BorderLayout.))
    ...
    wrapper)) 
 (m/=> create-tab-content-wrapper [:=> [:cat :keyword [:=> [:cat [:maybe :keyword]] :any]] [:fn (fn* [p1__4249#] (instance? JPanel p1__4249#))]])
...
(defn create-tabs
  ...
  (let [tabbed-pane (JTabbedPane. JTabbedPane/TOP)
    ...
    tabbed-pane)) 
 (m/=> create-tabs [:=> [:cat [:fn (fn* [p1__4259#] (instance? JFrame p1__4259#))] [:sequential :map]] [:fn (fn* [p1__4261#] (instance? JTabbedPane p1__4261#))]])
...
(defn create-default-tabs
 ...
 (m/=> create-default-tabs [:=> [:cat [:fn (fn* [p1__4277#] (instance? JFrame p1__4277#))]] [:fn (fn* [p1__4279#] (instance? JTabbedPane p1__4279#))]])
                              ...
                              (dotimes [i (.getTabCount tabbed-pane)]
                                (let [tab-config (nth tabs-config i nil)]
                                  (when (and tab-config (= (:key tab-config) tab-key))
                                    (.setSelectedIndex tabbed-pane i)))))))
  nil) 
 (m/=> reload-tabs! [:=> [:cat [:fn (fn* [p1__4289#] (instance? JFrame p1__4289#))] [:fn (fn* [p1__4291#] (instance? JTabbedPane p1__4291#))] [:sequential :map]] :nil])
...
(defn focus-roi
  ...
  (let [state-time (or (get-in @state/app-state [:server-state :system_monotonic_time_us]) 0)]
    (core/create-command
      {:heat_camera {:focus_roi {:x1 x1 :y1 y1 :x2 x2 :y2 y2 :frame_time frame-time :state_time state-time}}})))
...
(defn track-roi
  ...
  (let [state-time (or (get-in @state/app-state [:server-state :system_monotonic_time_us]) 0)]
    (core/create-command
      {:heat_camera {:track_roi {:x1 x1 :y1 y1 :x2 x2 :y2 y2 :frame_time frame-time :state_time state-time}}})))
...
(defn zoom-roi
  ...
  (let [state-time (or (get-in @state/app-state [:server-state :system_monotonic_time_us]) 0)]
    (core/create-command
      {:heat_camera {:zoom_roi {:x1 x1 :y1 y1 :x2 x2 :y2 y2 :frame_time frame-time :state_time state-time}}})))

...
class WindowEventHandler(
    ...
    interface EventCallback {
        fun onWindowEvent(type: EventFilter.EventType, eventName: String, details: Map<String, Any>?)
    }
    ...
    private fun scheduleWindowEvent(
        ...
        if (now - lastTime >= Constants.WINDOW_EVENT_THROTTLE_MS) {
            ...
            val newTask = eventThrottleExecutor.schedule({
                task()
    ...
    private fun sendFilteredWindowEvent(type: EventFilter.EventType, eventName: String, details: Map<String, Any>?) {

    ...
    class ProtobufReadHandler : ReadHandler<Message, Map<*, *>> {
        ...
        override fun fromRep(rep: Map<*, *>): Message {
            ...
            if (type == "protobuf-command") {
                ...
                val protoType = rep[TransitFactory.keyword("proto-type")] as? String
                ...
                val data = rep[TransitFactory.keyword("data")] as? Map<*, *>
                ...
                if (metadata != null) {
                    val protoType = metadata[TransitFactory.keyword("proto-type")] as? String
        ...
        private fun buildProtobuf(
            ...
            try {
                ...
                throw IllegalArgumentException(
                    "Failed to build protobuf of type $className: ${e.message}", e
                )
            }
        }
            ...
            when (fieldName) {
                "goto", "start", "stop", "halt" -> {
                    ...
                    try {
                        ...
                        val innerBuilderMethod = builder.javaClass.getMethod(
                            "${methodName}Builder"
                        )
        ...
        private fun isCompatibleType(paramType: Class<*>, value: Any?): Boolean {

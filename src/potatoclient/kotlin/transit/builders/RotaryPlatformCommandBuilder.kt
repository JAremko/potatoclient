...
object RotaryPlatformCommandBuilder {
    ...
    private fun buildRotateToGps(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
    ...
    private fun buildRotateAzimuth(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildRotateElevationTo(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildScanPause(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildHaltElevation(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildScanStart(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildSetElevationValue(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildElevation(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildRotateElevationRelative(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildSetPlatformAzimuth(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildScanStop(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildHaltAzimuth(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildStart(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildAzimuth(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildStop(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildRotateAzimuthRelative(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildSetOriginGps(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildScanNext(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildSetPlatformBank(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildGetMeteo(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildSetUseRotaryAsCompass(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildRotateAzimuthRelativeSet(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildScanPrev(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildScanAddNode(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildSetPlatformElevation(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildRotateElevationRelativeSet(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildScanSelectNode(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildHalt(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildScanDeleteNode(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildAxis(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildScanUnpause(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildRotateElevation(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildRotateAzimuthTo(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildSetMode(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildSetAzimuthValue(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildScanRefreshNodeList(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()
    ...
    private fun buildScanUpdateNode(params: Map<*, *>): Result<JonSharedCmdRotary.Root> =
        Result.success(
            JonSharedCmdRotary.Root
                .newBuilder()

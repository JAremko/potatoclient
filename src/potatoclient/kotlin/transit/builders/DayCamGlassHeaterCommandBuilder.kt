...
object DayCamGlassHeaterCommandBuilder {
    ...
    private fun buildStart(params: Map<*, *>): Result<JonSharedCmdDayCamGlassHeater.Root> =
        Result.success(
    ...
    private fun buildStop(params: Map<*, *>): Result<JonSharedCmdDayCamGlassHeater.Root> =
        Result.success(
            JonSharedCmdDayCamGlassHeater.Root
                .newBuilder()
    ...
    private fun buildTurnOn(params: Map<*, *>): Result<JonSharedCmdDayCamGlassHeater.Root> =
        Result.success(
            JonSharedCmdDayCamGlassHeater.Root
                .newBuilder()
    ...
    private fun buildTurnOff(params: Map<*, *>): Result<JonSharedCmdDayCamGlassHeater.Root> =
        Result.success(
            JonSharedCmdDayCamGlassHeater.Root
                .newBuilder()
    ...
    private fun buildGetMeteo(params: Map<*, *>): Result<JonSharedCmdDayCamGlassHeater.Root> =
        Result.success(
            JonSharedCmdDayCamGlassHeater.Root
                .newBuilder()

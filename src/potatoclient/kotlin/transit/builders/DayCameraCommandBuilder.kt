...
object DayCameraCommandBuilder {
    ...
    private fun buildPrevZoomTablePos(params: Map<*, *>): Result<JonSharedCmdDayCamera.Root> =
        Result.success(
    ...
    private fun buildZoom(params: Map<*, *>): Result<JonSharedCmdDayCamera.Root> =
        Result.success(
            JonSharedCmdDayCamera.Root
                .newBuilder()
    ...
    private fun buildOffset(params: Map<*, *>): Result<JonSharedCmdDayCamera.Root> =
        Result.success(
            JonSharedCmdDayCamera.Root
                .newBuilder()
    ...
    private fun buildPrevFxMode(params: Map<*, *>): Result<JonSharedCmdDayCamera.Root> =
        Result.success(
            JonSharedCmdDayCamera.Root
                .newBuilder()
    ...
    private fun buildStart(params: Map<*, *>): Result<JonSharedCmdDayCamera.Root> =
        Result.success(
            JonSharedCmdDayCamera.Root
                .newBuilder()
    ...
    private fun buildMove(params: Map<*, *>): Result<JonSharedCmdDayCamera.Root> =
        Result.success(
            JonSharedCmdDayCamera.Root
                .newBuilder()
    ...
    private fun buildResetFocus(params: Map<*, *>): Result<JonSharedCmdDayCamera.Root> =
        Result.success(
            JonSharedCmdDayCamera.Root
                .newBuilder()
    ...
    private fun buildHaltAll(params: Map<*, *>): Result<JonSharedCmdDayCamera.Root> =
        Result.success(
            JonSharedCmdDayCamera.Root
                .newBuilder()
    ...
    private fun buildGetPos(params: Map<*, *>): Result<JonSharedCmdDayCamera.Root> =
        Result.success(
            JonSharedCmdDayCamera.Root
                .newBuilder()
    ...
    private fun buildStop(params: Map<*, *>): Result<JonSharedCmdDayCamera.Root> =
        Result.success(
            JonSharedCmdDayCamera.Root
                .newBuilder()
    ...
    private fun buildResetZoom(params: Map<*, *>): Result<JonSharedCmdDayCamera.Root> =
        Result.success(
            JonSharedCmdDayCamera.Root
                .newBuilder()
    ...
    private fun buildSaveToTableFocus(params: Map<*, *>): Result<JonSharedCmdDayCamera.Root> =
        Result.success(
            JonSharedCmdDayCamera.Root
                .newBuilder()
    ...
    private fun buildPhoto(params: Map<*, *>): Result<JonSharedCmdDayCamera.Root> =
        Result.success(
            JonSharedCmdDayCamera.Root
                .newBuilder()
    ...
    private fun buildGetMeteo(params: Map<*, *>): Result<JonSharedCmdDayCamera.Root> =
        Result.success(
            JonSharedCmdDayCamera.Root
                .newBuilder()
    ...
    private fun buildNextZoomTablePos(params: Map<*, *>): Result<JonSharedCmdDayCamera.Root> =
        Result.success(
            JonSharedCmdDayCamera.Root
                .newBuilder()
    ...
    private fun buildFocus(params: Map<*, *>): Result<JonSharedCmdDayCamera.Root> =
        Result.success(
            JonSharedCmdDayCamera.Root
                .newBuilder()
    ...
    private fun buildSetValue(params: Map<*, *>): Result<JonSharedCmdDayCamera.Root> =
        Result.success(
            JonSharedCmdDayCamera.Root
                .newBuilder()
    ...
    private fun buildSetZoomTableValue(params: Map<*, *>): Result<JonSharedCmdDayCamera.Root> =
        Result.success(
            JonSharedCmdDayCamera.Root
                .newBuilder()
    ...
    private fun buildRefreshFxMode(params: Map<*, *>): Result<JonSharedCmdDayCamera.Root> =
        Result.success(
            JonSharedCmdDayCamera.Root
                .newBuilder()
    ...
    private fun buildHalt(params: Map<*, *>): Result<JonSharedCmdDayCamera.Root> =
        Result.success(
            JonSharedCmdDayCamera.Root
                .newBuilder()
    ...
    private fun buildSaveToTable(params: Map<*, *>): Result<JonSharedCmdDayCamera.Root> =
        Result.success(
            JonSharedCmdDayCamera.Root
                .newBuilder()
    ...
    private fun buildNextFxMode(params: Map<*, *>): Result<JonSharedCmdDayCamera.Root> =
        Result.success(
            JonSharedCmdDayCamera.Root
                .newBuilder()

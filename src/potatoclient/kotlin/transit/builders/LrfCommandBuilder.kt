...
object LrfCommandBuilder {
    ...
    private fun buildTargetDesignatorOff(params: Map<*, *>): Result<JonSharedCmdLrf.Root> =
        Result.success(
    ...
    private fun buildTargetDesignatorOnModeB(params: Map<*, *>): Result<JonSharedCmdLrf.Root> =
        Result.success(
            JonSharedCmdLrf.Root
                .newBuilder()
    ...
    private fun buildDisableFogMode(params: Map<*, *>): Result<JonSharedCmdLrf.Root> =
        Result.success(
            JonSharedCmdLrf.Root
                .newBuilder()
    ...
    private fun buildRefineOff(params: Map<*, *>): Result<JonSharedCmdLrf.Root> =
        Result.success(
            JonSharedCmdLrf.Root
                .newBuilder()
    ...
    private fun buildScanOff(params: Map<*, *>): Result<JonSharedCmdLrf.Root> =
        Result.success(
            JonSharedCmdLrf.Root
                .newBuilder()
    ...
    private fun buildRefineOn(params: Map<*, *>): Result<JonSharedCmdLrf.Root> =
        Result.success(
            JonSharedCmdLrf.Root
                .newBuilder()
    ...
    private fun buildStart(params: Map<*, *>): Result<JonSharedCmdLrf.Root> =
        Result.success(
            JonSharedCmdLrf.Root
                .newBuilder()
    ...
    private fun buildMeasure(params: Map<*, *>): Result<JonSharedCmdLrf.Root> =
        Result.success(
            JonSharedCmdLrf.Root
                .newBuilder()
    ...
    private fun buildScanOn(params: Map<*, *>): Result<JonSharedCmdLrf.Root> =
        Result.success(
            JonSharedCmdLrf.Root
                .newBuilder()
    ...
    private fun buildStop(params: Map<*, *>): Result<JonSharedCmdLrf.Root> =
        Result.success(
            JonSharedCmdLrf.Root
                .newBuilder()
    ...
    private fun buildNewSession(params: Map<*, *>): Result<JonSharedCmdLrf.Root> =
        Result.success(
            JonSharedCmdLrf.Root
                .newBuilder()
    ...
    private fun buildGetMeteo(params: Map<*, *>): Result<JonSharedCmdLrf.Root> =
        Result.success(
            JonSharedCmdLrf.Root
                .newBuilder()
    ...
    private fun buildEnableFogMode(params: Map<*, *>): Result<JonSharedCmdLrf.Root> =
        Result.success(
            JonSharedCmdLrf.Root
                .newBuilder()
    ...
    private fun buildTargetDesignatorOnModeA(params: Map<*, *>): Result<JonSharedCmdLrf.Root> =
        Result.success(
            JonSharedCmdLrf.Root
                .newBuilder()

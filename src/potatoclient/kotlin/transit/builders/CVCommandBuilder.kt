...
object CVCommandBuilder {
    ...
    private fun buildVampireModeEnable(params: Map<*, *>): Result<JonSharedCmdCv.Root> =
        Result.success(
            JonSharedCmdCv.Root
                .newBuilder()
    ...
    private fun buildVampireModeDisable(params: Map<*, *>): Result<JonSharedCmdCv.Root> =
        Result.success(
            JonSharedCmdCv.Root
                .newBuilder()
    ...
    private fun buildDumpStop(params: Map<*, *>): Result<JonSharedCmdCv.Root> =
        Result.success(
            JonSharedCmdCv.Root
                .newBuilder()
    ...
    private fun buildStabilizationModeDisable(params: Map<*, *>): Result<JonSharedCmdCv.Root> =
        Result.success(
            JonSharedCmdCv.Root
                .newBuilder()
    ...
    private fun buildDumpStart(params: Map<*, *>): Result<JonSharedCmdCv.Root> =
        Result.success(
            JonSharedCmdCv.Root
                .newBuilder()
    ...
    private fun buildStopTrack(params: Map<*, *>): Result<JonSharedCmdCv.Root> =
        Result.success(
            JonSharedCmdCv.Root
                .newBuilder()
    ...
    private fun buildStabilizationModeEnable(params: Map<*, *>): Result<JonSharedCmdCv.Root> =
        Result.success(
            JonSharedCmdCv.Root
                .newBuilder()

...
object SystemCommandBuilder {
    ...
    private fun buildEnableGeodesicMode(params: Map<*, *>): Result<JonSharedCmdSystem.Root> = Result.success(
        JonSharedCmdSystem.Root.newBuilder()
            .setEnableGeodesicMode(JonSharedCmdSystem.EnableGeodesicMode.newBuilder().build())
            .build()
    )

    private fun buildUnmarkRecImportant(params: Map<*, *>): Result<JonSharedCmdSystem.Root> = Result.success(
        JonSharedCmdSystem.Root.newBuilder()
            .setUnmarkRecImportant(JonSharedCmdSystem.UnmarkRecImportant.newBuilder().build())
            .build()
    )

    private fun buildStopRec(params: Map<*, *>): Result<JonSharedCmdSystem.Root> = Result.success(
        JonSharedCmdSystem.Root.newBuilder()
            .setStopRec(JonSharedCmdSystem.StopRec.newBuilder().build())
            .build()
    )

    private fun buildStopALl(params: Map<*, *>): Result<JonSharedCmdSystem.Root> = Result.success(
        JonSharedCmdSystem.Root.newBuilder()
            .setStopAll(JonSharedCmdSystem.StopALl.newBuilder().build())
            .build()
    )

    private fun buildReboot(params: Map<*, *>): Result<JonSharedCmdSystem.Root> = Result.success(
        JonSharedCmdSystem.Root.newBuilder()
            .setReboot(JonSharedCmdSystem.Reboot.newBuilder().build())
            .build()
    )

    private fun buildStartRec(params: Map<*, *>): Result<JonSharedCmdSystem.Root> = Result.success(
        JonSharedCmdSystem.Root.newBuilder()
            .setStartRec(JonSharedCmdSystem.StartRec.newBuilder().build())
            .build()
    )

    private fun buildPowerOff(params: Map<*, *>): Result<JonSharedCmdSystem.Root> = Result.success(
        JonSharedCmdSystem.Root.newBuilder()
            .setPowerOff(JonSharedCmdSystem.PowerOff.newBuilder().build())
            .build()
    )

    private fun buildSetLocalization(params: Map<*, *>): Result<JonSharedCmdSystem.Root> = Result.success(
        JonSharedCmdSystem.Root.newBuilder()
            .setSetLocalization(JonSharedCmdSystem.SetLocalization.newBuilder().build())
            .build()
    )

    private fun buildResetConfigs(params: Map<*, *>): Result<JonSharedCmdSystem.Root> = Result.success(
        JonSharedCmdSystem.Root.newBuilder()
            .setResetConfigs(JonSharedCmdSystem.ResetConfigs.newBuilder().build())
            .build()
    )

    private fun buildDisableGeodesicMode(params: Map<*, *>): Result<JonSharedCmdSystem.Root> = Result.success(
        JonSharedCmdSystem.Root.newBuilder()
            .setDisableGeodesicMode(JonSharedCmdSystem.DisableGeodesicMode.newBuilder().build())
            .build()
    )

    private fun buildEnterTransport(params: Map<*, *>): Result<JonSharedCmdSystem.Root> = Result.success(
        JonSharedCmdSystem.Root.newBuilder()
            .setEnterTransport(JonSharedCmdSystem.EnterTransport.newBuilder().build())
            .build()
    )

    private fun buildMarkRecImportant(params: Map<*, *>): Result<JonSharedCmdSystem.Root> = Result.success(
        JonSharedCmdSystem.Root.newBuilder()
            .setMarkRecImportant(JonSharedCmdSystem.MarkRecImportant.newBuilder().build())
            .build()
    )

    private fun buildStartALl(params: Map<*, *>): Result<JonSharedCmdSystem.Root> = Result.success(
        JonSharedCmdSystem.Root.newBuilder()

...
object CompassCommandBuilder {
    ...
    private fun buildCalibrateCencel(params: Map<*, *>): Result<JonSharedCmdCompass.Root> =
        Result.success(
    ...
    private fun buildStart(params: Map<*, *>): Result<JonSharedCmdCompass.Root> =
        Result.success(
            JonSharedCmdCompass.Root
                .newBuilder()
    ...
    private fun buildCalibrateStartShort(params: Map<*, *>): Result<JonSharedCmdCompass.Root> =
        Result.success(
            JonSharedCmdCompass.Root
                .newBuilder()
    ...
    private fun buildStop(params: Map<*, *>): Result<JonSharedCmdCompass.Root> =
        Result.success(
            JonSharedCmdCompass.Root
                .newBuilder()
    ...
    private fun buildCalibrateStartLong(params: Map<*, *>): Result<JonSharedCmdCompass.Root> =
        Result.success(
            JonSharedCmdCompass.Root
                .newBuilder()
    ...
    private fun buildCalibrateNext(params: Map<*, *>): Result<JonSharedCmdCompass.Root> =
        Result.success(
            JonSharedCmdCompass.Root
                .newBuilder()
    ...
    private fun buildGetMeteo(params: Map<*, *>): Result<JonSharedCmdCompass.Root> =
        Result.success(
            JonSharedCmdCompass.Root
                .newBuilder()

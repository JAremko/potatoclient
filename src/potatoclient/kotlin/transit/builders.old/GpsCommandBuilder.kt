...
object GpsCommandBuilder {
    ...
    private fun buildStart(params: Map<*, *>): Result<JonSharedCmdGps.Root> =
        Result.success(
    ...
    private fun buildStop(params: Map<*, *>): Result<JonSharedCmdGps.Root> =
        Result.success(
            JonSharedCmdGps.Root
                .newBuilder()
    ...
    private fun buildGetMeteo(params: Map<*, *>): Result<JonSharedCmdGps.Root> =
        Result.success(
            JonSharedCmdGps.Root
                .newBuilder()

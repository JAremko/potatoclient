...
object SimpleCommandHandlers {
    ...
    private fun buildSystemPowerOff() =
        JonSharedCmd.Root
            .newBuilder()
            .setProtocolVersion(1)
            .setSystem(
    ...
    private fun buildSystemResetConfigs() =
        JonSharedCmd.Root
            .newBuilder()
            .setProtocolVersion(1)
            .setSystem(
    ...
    private fun buildSystemStartAll() =
        JonSharedCmd.Root
            .newBuilder()
            .setProtocolVersion(1)
            .setSystem(
    ...
    private fun buildSystemStopAll() =
        JonSharedCmd.Root
            .newBuilder()
            .setProtocolVersion(1)
            .setSystem(
    ...
    private fun buildSystemMarkRecImportant() =
        JonSharedCmd.Root
            .newBuilder()
            .setProtocolVersion(1)
            .setSystem(
    ...
    private fun buildSystemUnmarkRecImportant() =
        JonSharedCmd.Root
            .newBuilder()
            .setProtocolVersion(1)
            .setSystem(
    ...
    private fun buildSystemEnterTransport() =
        JonSharedCmd.Root
            .newBuilder()
            .setProtocolVersion(1)
            .setSystem(
    ...
    private fun buildSystemEnableGeodesicMode() =
        JonSharedCmd.Root
            .newBuilder()
            .setProtocolVersion(1)
            .setSystem(
    ...
    private fun buildSystemDisableGeodesicMode() =
        JonSharedCmd.Root
            .newBuilder()
            .setProtocolVersion(1)
            .setSystem(

...
class TestModeWebSocketStub(
    ...
    private suspend fun handleRotaryCommand(rotary: JonSharedCmdRotary.Root, commandId: Int): Map<String, Any> {
    ...
    private fun handleCvCommand(cv: JonSharedCmdCv.Root, commandId: Int): Map<String, Any> {
        return when {
            cv.hasStartTrackNdc() -> {
     ...
     */
    fun simulateStateUpdates(): Flow<Message> = flow {

...
class MouseEventHandler(
    ...
    private data class ClickInfo(
        ...
        fun isDoubleClick(x: Int, y: Int, button: Int, timestamp: Long): Boolean {
    ...
    fun attachListeners() {
        ...
        videoComponent.addMouseMotionListener(object : MouseMotionAdapter() {
            ...
            private fun getButtonFromModifiers(modifiers: Int): Int {
                return when (modifiers and (MouseEvent.BUTTON1_DOWN_MASK or MouseEvent.BUTTON2_DOWN_MASK or MouseEvent.BUTTON3_DOWN_MASK)) {

...
(defn set-focus
  "Set the focus value (0.0 to 1.0).
   Returns a fully formed cmd root ready to send." {:malli/schema [:=> [:cat :range/focus] :cmd/root]}
  [value]
  (core/create-command 
...
(defn move-focus
  "Move focus to target value at specified speed.
   ...
   Returns a fully formed cmd root ready to send." {:malli/schema [:=> [:cat :range/normalized :speed/normalized] :cmd/root]}
  [target-value speed]
  (core/create-command 
...
(defn set-zoom
  "Set the zoom value (0.0 to 1.0).
   Returns a fully formed cmd root ready to send." {:malli/schema [:=> [:cat :range/zoom] :cmd/root]}
  [value]
  (core/create-command 
...
(defn set-fx-mode
  "Set the FX mode for the day camera.
   ...
   Returns a fully formed cmd root ready to send." {:malli/schema [:=> [:cat :enum/fx-mode-day] :cmd/root]}
  [mode]
  (core/create-command 

...
(defn set-magnetic-declination
  "Set the magnetic declination angle in mils.
   Returns a fully formed cmd root ready to send." {:malli/schema [:=> [:cat :angle/magnetic-declination] :cmd/root]}
  [value]
...
(defn set-offset-angle-azimuth
  "Set the offset angle for azimuth in mils.
   Returns a fully formed cmd root ready to send." {:malli/schema [:=> [:cat :angle/offset-azimuth] :cmd/root]}
  [value]
...
(defn set-offset-angle-elevation
  "Set the offset angle for elevation in mils.
   Returns a fully formed cmd root ready to send." {:malli/schema [:=> [:cat :angle/offset-elevation] :cmd/root]}
  [value]

...
(def system-message-spec
  [:map {:closed true}
   ...
   [:cur_video_rec_dir_year [:int {:min 0}]]
   [:cur_video_rec_dir_month [:int {:min 0}]]
   [:cur_video_rec_dir_day [:int {:min 0}]]
   [:cur_video_rec_dir_hour [:int {:min 0}]]
   [:cur_video_rec_dir_minute [:int {:min 0}]]
   [:cur_video_rec_dir_second [:int {:min 0}]]
   [:rec_enabled :boolean]

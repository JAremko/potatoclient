...
(def root "Schema for root" [:map [:cmd [:oneof {:calibrate-cencel [:map [:calibrate-cencel :cmd/calibrate-cencel]], :start [:map [:start :cmd/start]], :set-offset-angle-elevation [:map [:set-offset-angle-elevation :cmd/set-offset-angle-elevation]], :stop [:map [:stop :cmd/stop]], :calibrate-next [:map [:calibrate-next :cmd/calibrate-next]], :get-meteo [:map [:get-meteo :cmd/get-meteo]], :set-use-rotary-position [:map [:set-use-rotary-position :cmd/set-use-rotary-position]], :set-magnetic-declination [:map [:set-magnetic-declination :cmd/set-magnetic-declination]], :start-calibrate-short [:map [:start-calibrate-short :cmd/calibrate-start-short]], :start-calibrate-long [:map [:start-calibrate-long :cmd/calibrate-start-long]], :set-offset-angle-azimuth [:map [:set-offset-angle-azimuth :cmd/set-offset-angle-azimuth]]}]]])

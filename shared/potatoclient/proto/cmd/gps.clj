...
(>defn- build-root-payload
        ...
        (case field-key
          :start (.setStart builder value)
          :stop (.setStop builder value)
          :set-manual-position (.setSetManualPosition builder value)
          :set-use-manual-position (.setSetUseManualPosition builder value)
          :get-meteo (.setGetMeteo builder value)
...
(>defn- parse-root-payload
        ...
        [^cmd.Gps.JonSharedCmdGps$Root proto]
        [any? => (? map?)]
        (cond (.hasStart proto) {:start (.getStart proto)}
              (.hasStop proto) {:stop (.getStop proto)}
              (.hasSetManualPosition proto) {:set-manual-position
                                               (.getSetManualPosition proto)}
              (.hasSetUseManualPosition proto)
                {:set-use-manual-position (.getSetUseManualPosition proto)}
              (.hasGetMeteo proto) {:get-meteo (.getGetMeteo proto)}))
;; =============================================================================

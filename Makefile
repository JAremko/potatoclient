...
help: ## Show this help message
	...
	@echo ""
	@echo "Development:"
	@grep -E '^(nrepl|check-deps|build-macos-dev|report-unspecced|fmt|fmt-check|lint-clj|lint-kotlin|lint-kotlin-detekt|lint|lint-report):.*?## .*$$' $(MAKEFILE_LIST) | awk 'BEGIN {FS = ":.*?## "}; {printf "  %-15s %s\n", $$1, $$2}'
	@echo ""
...
# Generate organized lint reports
.PHONY: lint-report
lint-report: ## Generate organized lint reports separated by language and severity
	@echo "Generating organized lint reports..."
	@bb scripts/lint-report-organized.bb
	@echo "✓ Reports generated in reports/lint/"
	@echo "  View summary at: reports/lint/summary.md"

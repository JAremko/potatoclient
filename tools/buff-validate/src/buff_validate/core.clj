(ns buff-validate.core
  "Main entry point for the buff-validate CLI tool."
  (:require
...
(defn usage
  ...
  (str/join
   \newline
   ["buff-validate - Protobuf Binary Validation Tool"
    ""
    "Usage: buff-validate [options]"
    ""
    "Options:"
    options-summary
    ""
    "Examples:"
    "  buff-validate -f output/state_20241208.bin"
    "  buff-validate -f commands.bin -t cmd"
    "  buff-validate -f data.bin -o json"
    "  buff-validate -f state.bin -t state -v"
    ""
    "Message Types:"

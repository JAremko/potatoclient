...
# Main execution
main() {
    print_info "CMD-Explorer Proto Generation"
    print_info "=============================="
    ...
    TEMP_DIR=$(mktemp -d -t cmd-explorer-protogen.XXXXXX)
    ...
    TEMP_OUTPUT=$(mktemp -d -t cmd-explorer-output.XXXXXX)
...
'
    ...
    print_info ""
    print_info "Next step: Run 'make compile-proto' to compile Java sources"
}

...
class IpcClient(
     ...
     */
    fun sendGestureEventWithNDC(
        event: potatoclient.kotlin.gestures.GestureEvent,
        ndcX: Double,
        ndcY: Double,
    ) {
        when (event) {

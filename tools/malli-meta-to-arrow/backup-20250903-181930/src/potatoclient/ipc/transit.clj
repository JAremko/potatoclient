...
(defn write-message
  ...
  {:malli/schema [:=> [:cat TransitMessage] ByteArray]}
  [message]
...
(defn read-message
  ...
  {:malli/schema [:=> [:cat ByteArray] TransitMessage]}
  [bytes]
...
(defn keyword->transit
  ...
  {:malli/schema [:=> [:cat :keyword] [:fn (partial instance? Keyword)]]}
  [kw]
...
(defn transit->keyword
  ...
  {:malli/schema [:=> [:cat [:fn (partial instance? Keyword)]] :keyword]}
  [^Keyword transit-kw]
...
(defn create-message
  ...
  {:malli/schema [:=> [:cat :keyword [:map-of :keyword :any]] TransitMessage]}
  [msg-type payload]
...
(defn create-log
  ...
  {:malli/schema [:=> [:cat :keyword :string [:? [:map-of :keyword :any]]] TransitMessage]}
  [level message & [data]]
  (create-message :log
                  (cond-> {:level level
                           :message message}
...
(defn create-metric
  ...
  {:malli/schema [:=> [:cat [:map-of :keyword :any]] TransitMessage]}
  [metric-data]

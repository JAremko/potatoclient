(ns test.proto.ns.cmd
  ...
  (:require [com.fulcrologic.guardrails.malli.core :refer [=> >defn >defn- ?]]
            [malli.core :as m]
            [test.proto.ns.lira :as lira]
            [test.proto.ns.rotaryplatform :as rotaryplatform]
            [test.proto.ns.system :as system]
            [test.proto.ns.lrf_calib :as lrf_calib]
            [test.proto.ns.gps :as gps]
            [test.proto.ns.heatcamera :as heatcamera]
            [test.proto.ns.cv :as cv]
            [test.proto.ns.daycamera :as daycamera]
            [test.proto.ns.daycamglassheater :as daycamglassheater]
            [test.proto.ns.lrf :as lrf]
            [test.proto.ns.compass :as compass]
            [test.proto.ns.ser.data :as types]
            [test.proto.ns.osd :as osd])

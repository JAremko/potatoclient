(ns test.proto.ns.cmd
  "Generated protobuf functions."
  (:require [com.fulcrologic.guardrails.malli.core :refer [=> >defn >defn- ?]]
            [malli.core :as m]
            [malli.registry :as mr]
            [potatoclient.specs.malli-oneof :as oneof]
            [test.proto.ns.cmd.lira :as lira]
            [test.proto.ns.cmd.rotaryplatform :as rotaryplatform]
            [test.proto.ns.cmd.system :as system]
            [test.proto.ns.cmd.lrf-calib :as lrf-calib]
            [test.proto.ns.cmd.gps :as gps]
            [test.proto.ns.cmd.heatcamera :as heatcamera]
            [test.proto.ns.cmd.cv :as cv]
            [test.proto.ns.cmd.daycamera :as daycamera]
            [test.proto.ns.cmd.daycamglassheater :as daycamglassheater]
            [test.proto.ns.cmd.lrf :as lrf]
            [test.proto.ns.cmd.compass :as compass]
            [test.proto.ns.ser :as types]
            [test.proto.ns.cmd.osd :as osd])

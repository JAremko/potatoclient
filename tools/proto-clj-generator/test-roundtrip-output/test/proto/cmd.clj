(ns test.proto.cmd
  ...
  (:require [com.fulcrologic.guardrails.malli.core :refer [=> >defn >defn- ?]]
            ...
            [test.proto.cmd.lira :as lira]
            [test.proto.cmd.rotaryplatform :as rotaryplatform]
            [test.proto.cmd.system :as system]
            [test.proto.cmd.lrf-calib :as lrf-calib]
            [test.proto.cmd.gps :as gps]
            [test.proto.cmd.heatcamera :as heatcamera]
            [test.proto.cmd.cv :as cv]
            [test.proto.cmd.daycamera :as daycamera]
            [test.proto.cmd.daycamglassheater :as daycamglassheater]
            [test.proto.cmd.lrf :as lrf]
            [test.proto.cmd.compass :as compass]
            [test.proto.ser :as types]
            [test.proto.cmd.osd :as osd])
...
;; Warning: Could not extract spec for field client-type
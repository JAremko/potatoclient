(ns test.deps.ser.data
  "Generated protobuf functions."
  (:require [com.fulcrologic.guardrails.malli.core :refer [=> >defn >defn- ?]]
            [malli.core :as m]
            [test.deps.ser.system :as ser]
            [test.deps.ser.camera-day :as ser2]
            [test.deps.ser.types :as ser3]
            [test.deps.ser.compass :as ser4]
            [test.deps.ser.rotary :as ser5]
            [test.deps.ser.compass-calibration :as ser6]
            [test.deps.ser.day-cam-glass-heater :as ser7]
            [test.deps.ser.time :as ser8]
            [test.deps.ser.lrf :as ser9]
            [test.deps.ser.actual-space-time :as ser10]
            [test.deps.ser.camera-heat :as ser11]
            [test.deps.ser.gps :as ser12]
            [test.deps.ser.rec-osd :as ser13])

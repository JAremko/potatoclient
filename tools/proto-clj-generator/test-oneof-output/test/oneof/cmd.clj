(ns test.oneof.cmd
  ...
  (:require [com.fulcrologic.guardrails.malli.core :refer [=> >defn >defn- ?]]
            ...
            [test.oneof.cmd.lira :as lira]
            [test.oneof.cmd.rotaryplatform :as rotaryplatform]
            [test.oneof.cmd.system :as system]
            [test.oneof.cmd.lrf-calib :as lrf-calib]
            [test.oneof.cmd.gps :as gps]
            [test.oneof.cmd.heatcamera :as heatcamera]
            [test.oneof.cmd.cv :as cv]
            [test.oneof.cmd.daycamera :as daycamera]
            [test.oneof.cmd.daycamglassheater :as daycamglassheater]
            [test.oneof.cmd.lrf :as lrf]
            [test.oneof.cmd.compass :as compass]
            [test.oneof.ser :as types]
            [test.oneof.cmd.osd :as osd])

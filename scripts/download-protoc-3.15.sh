...
# Download protoc 3.15.0 for compatibility with protobuf-java 3.15.0
...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
    ...
    if [[ "$ARCH" == "x86_64" ]]; then
        ...
        # Note: protoc 3.15.0 doesn't have native arm64 builds for macOS
        # We'll use x86_64 with Rosetta
        PLATFORM="osx-x86_64"
    fi
fi
